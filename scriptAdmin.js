    ...
    fetch('/api/transactions')
        ...
        .then(transactions => {
            ...
            transactions.forEach(transaction => {
                ...
                // Aqui você deve adaptar para os campos retornados pelo MongoDB

                // Código adaptado para campos específicos de transações em MongoDB
                ...
                deleteButton.addEventListener('click', () => deleteTransactionHandler(transaction._id)); // Usando o _id do MongoDB
